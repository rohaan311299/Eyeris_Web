...
const { createOrder,getAllOrders,getPlacedOrderforAdmin,AcceptOrder,getMyOrders,cancelOrder,getOrderById,updateOrder,completeOrder } = require('../controllers/order');
...
router.get("/AcceptOrder/:id",authRequired("admin"),hasRoles("admin"),asyncHandler(completeOrder))
